...
function Home({ t }) {
    ...
    return (
        <>
            <div className='container bg-[url(/images/bgteste.png)] bg-fixed bg-cover bg-repeat-space flex flex-col justify-between text-center h-screen text-white p-4 sm:justify-start '>
